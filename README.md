# 🚦 النظام المتكامل — Firebase Web App

نظام متكامل لإدارة السائقين، المخالفات، الخصومات، التراخيص، العهد، الموافقات والفواتير — يعمل بـ **Firebase Firestore** كقاعدة بيانات وحيدة مع إمكانية استيراد البيانات من Google Sheets.
